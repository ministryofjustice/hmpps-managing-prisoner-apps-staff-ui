...
export const applicationTypeLabels: Record<keyof typeof APPLICATION_TYPE_VALUES, string> = {
  PIN_PHONE_ADD_NEW_SOCIAL_CONTACT: 'Add a social PIN phone contact',
  PIN_PHONE_ADD_NEW_OFFICIAL_CONTACT: 'Add an official PIN phone contact',
  PIN_PHONE_EMERGENCY_CREDIT_TOP_UP: 'Add emergency phone credit',
  PIN_PHONE_CREDIT_SWAP_VISITING_ORDERS: 'Swap Visiting Orders (VOs) for PIN Credit',
  PIN_PHONE_SUPPLY_LIST_OF_CONTACTS: 'Supply list of PIN phone contacts',
  PIN_PHONE_REMOVE_CONTACT: 'Add or remove a PIN phone contact',
}
