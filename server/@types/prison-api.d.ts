...
export interface paths {
  ...
  '/api/movements/offenders/{offenderNumber}/latest-arrival-date': {
    ...
    get: operations['getLatestArrivalDate']
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface components {
  schemas: {
    ...
    CalculableSentenceEnvelope: {
      ...
      /** @description Fixed term recall details */
      fixedTermRecallDetails?: components['schemas']['FixedTermRecallDetails']
      /** @description The current set of sentence dates determined by NOMIS or recorded via overrides */
      sentenceCalcDates?: components['schemas']['SentenceCalcDates']
      /** @description The external movements for this calculation */
    ...
    CorePersonPhysicalAttributes: {
       ...
       */
      hairCode?: string
      /** @description Description for hair type or colour */
       ...
       */
      facialHairCode?: string
      /** @description Description for facial hair type */
       ...
       */
      faceCode?: string
      /** @description Description for face shape */
       ...
       */
      leftEyeColourCode?: string
      /** @description Description for left eye colour */
       ...
       */
      rightEyeColourCode?: string
      /** @description Description for right eye colour */
