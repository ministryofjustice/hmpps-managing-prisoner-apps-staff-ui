...
const journey = APP_SUBMITTED_JOURNEYS.find(item => item.id === 1)
if (!journey) throw new Error('Journey definition for app type 1 is missing')

test.describe('Application Submitted - Add emergency phone credit', () => {
